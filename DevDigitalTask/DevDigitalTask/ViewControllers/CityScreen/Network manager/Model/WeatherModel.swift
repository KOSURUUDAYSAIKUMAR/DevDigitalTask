...
struct WeatherModel {
    ...
    static func getConditionNameBy(conditionId id: Int) -> String {
        switch id {
        case 200...232:
            return Dev.SystemImageName.cloudBoltFill
        case 300...321:
            return Dev.SystemImageName.cloudDrizzleFill
        case 500...531:
            return Dev.SystemImageName.cloudRainFill
        case 600...622:
            return Dev.SystemImageName.cloudSnowFill
        case 701...781:
            return Dev.SystemImageName.cloudFogFill
        case 800:
            return Dev.SystemImageName.sunMaxFill
        case 801...804:
            return Dev.SystemImageName.cloudFill
        default:
            return "error"
        }
    }
