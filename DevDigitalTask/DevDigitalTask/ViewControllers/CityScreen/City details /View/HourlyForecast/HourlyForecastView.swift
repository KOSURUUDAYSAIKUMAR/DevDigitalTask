...
extension HourlyForecastView: UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let safeWeatherData = dataSource,
              let cell = collectionView.dequeueReusableCell(withReuseIdentifier: Dev.CellIdentifier.hourlyForecastCell,
        ...
        case .sunState(let sunStete):
            ...
            case .sunset:
                ...
                cell.imageView.image = UIImage(systemName: Dev.SystemImageName.sunsetFill,
                                               withConfiguration: imageConfiguration) ?? UIImage()
            case .sunrise:
                cell.bottomLabel.text = "Sunrise"
                cell.imageView.image = UIImage(systemName: Dev.SystemImageName.sunriseFill,
                                               withConfiguration: imageConfiguration) ?? UIImage()
            }
