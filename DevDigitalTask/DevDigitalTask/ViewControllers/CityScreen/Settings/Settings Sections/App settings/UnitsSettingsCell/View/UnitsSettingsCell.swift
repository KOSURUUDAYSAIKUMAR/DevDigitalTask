...
class UnitsSettingsCell: UITableViewCell, ReloadColorThemeProtocol {
    ...
    private lazy var unitSwitch: UISegmentedControl = {
        ...
        switcher.accessibilityIdentifier = Dev.AccessabilityIdentifier.settingsUnitSwitch
    ...
    private lazy var settingsIcon: UIImageView = {
        ...
        imageView.image = UIImage(systemName: Dev.SystemImageName.ruler, withConfiguration: imageConfiguration) ?? UIImage()
    ...
    init(colorThemeComponent: ColorThemeProtocol) {
        ...
        case Dev.UserDefaults.metric:
            unitSwitch.selectedSegmentIndex = 0
        case Dev.UserDefaults.imperial:
