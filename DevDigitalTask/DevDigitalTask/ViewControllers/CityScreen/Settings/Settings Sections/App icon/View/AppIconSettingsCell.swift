...
class AppIconSettingsCell: UITableViewCell, ReloadColorThemeProtocol {
    ...
    private let collectionView: UICollectionView = {
        ...
        collectionView.register(AppIconCollectionViewCell.self, forCellWithReuseIdentifier: Dev.CellIdentifier.appIconCell)
...
extension AppIconSettingsCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: Dev.CellIdentifier.appIconCell, for: indexPath) as? AppIconCollectionViewCell else {
