...
class ColorThemeSettingsView: UIView, ReloadColorThemeProtocol {
    ...
    private var tableView: UITableView = {
        ...
        tableView.accessibilityIdentifier = Dev.AccessabilityIdentifier.colorSettingsTableView
        tableView.translatesAutoresizingMaskIntoConstraints = false
        tableView.register(ColorThemeCell.self, forCellReuseIdentifier: Dev.CellIdentifier.colorThemeCell)
...
extension ColorThemeSettingsView: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: Dev.CellIdentifier.colorThemeCell) as? ColorThemeCell else {
