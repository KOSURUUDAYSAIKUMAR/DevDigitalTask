...
class CityDetailView: UIView, CityDetailViewProtocol {
    ...
    private var conditionImage: UIImageView = {
        ...
        imageView.image = UIImage(named: Dev.SystemImageName.cloudFill)
    ...
    private lazy var secondScreenPartBackground: UIView = {
        let view = UIView()
        let contentBackground = colorThemeComponent.cityDetails.contentBackground
    ...
    init(colorThemeComponent: ColorThemeModel) {
        ...
        let backgroundColors = colorThemeComponent.cityDetails.screenBackground
    ...
    private func setupActivatedArrowHint(_ isActivated: Bool) {
        let arrowDown = UIImage(systemName: Dev.SystemImageName.arrowDown) ?? UIImage()
        let arrowUp = UIImage(systemName: Dev.SystemImageName.arrowUp) ?? UIImage()
    ...
    private func setLabelsAndImages(with newData: WeatherModel) {
        ...
        let backgroundColors = colorThemeComponent.cityDetails.screenBackground
        let inheritedIconColor = colorThemeComponent.getColorByConditionId(newData.conditionId).iconsColor
...
extension CityDetailView {
    ...
    private func setupGradientBackground() {
        let cityDetails = colorThemeComponent.cityDetails
        ...
        let currentWeatherColors = colorThemeComponent.getColorByConditionId(0).colors
