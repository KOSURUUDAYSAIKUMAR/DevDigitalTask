...
class HourlyCollectionViewCell: UICollectionViewCell {
    ...
    func setupColorTheme(_ colorTheme: ColorThemeModel) {
        topLabel.textColor = colorTheme.cityDetails.hourlyForecast.labelsColor
        bottomLabel.textColor = colorTheme.cityDetails.hourlyForecast.labelsSecondaryColor
    }
