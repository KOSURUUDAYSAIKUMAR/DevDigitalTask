...
class WeatherQualityInfoView: UIView {
    ...
    private lazy var backgroundView: UIView = {
        ...
        if colorThemeComponent.cityDetails.weatherQuality.isShadowVisible {
            DesignManager.setBackgroundStandartShadow(layer: view.layer)
        }
        let weatherQualityColor = colorThemeComponent.cityDetails.weatherQuality
    ...
    private lazy var uvIndexItemView: WeatherQualityItemView = {
        ...
        qualityItem.imageView.image = UIImage(systemName: Dev.SystemImageName.sunMaxFill,
                                              withConfiguration: DesignManager.standartImageConfiguration)?.withRenderingMode(.alwaysTemplate)
        qualityItem.tintColor = colorThemeComponent.cityDetails.iconColors.uvIndex
        qualityItem.titleLabel.text = "UV index"
        qualityItem.titleLabel.textColor = colorThemeComponent.cityDetails.weatherQuality.labelsColor
        qualityItem.subTitleLabel.text = "-"
        qualityItem.subTitleLabel.textColor = colorThemeComponent.cityDetails.weatherQuality.labelsSecondaryColor
        return qualityItem
    }()

    private lazy var humidityItemView: WeatherQualityItemView = {
        let qualityItem = WeatherQualityItemView()
        qualityItem.imageView.image = UIImage(systemName: Dev.SystemImageName.drop,
                                              withConfiguration: DesignManager.standartImageConfiguration)?.withRenderingMode(.alwaysTemplate)
        qualityItem.tintColor = colorThemeComponent.cityDetails.iconColors.humidity
    ...
    private lazy var cloudinessItemView: WeatherQualityItemView = {
        let qualityItem = WeatherQualityItemView()
        qualityItem.imageView.image = UIImage(systemName: Dev.SystemImageName.cloudFill, withConfiguration: DesignManager.standartImageConfiguration)?.withRenderingMode(.alwaysTemplate)
        qualityItem.tintColor = colorThemeComponent.cityDetails.iconColors.cloudiness
    ...
    private lazy var windItemView: WeatherQualityItemView = {
        let qualityItem = WeatherQualityItemView()
        qualityItem.imageView.image = UIImage(systemName: Dev.SystemImageName.wind,
                                              withConfiguration: DesignManager.standartImageConfiguration)?.withRenderingMode(.alwaysTemplate)
        qualityItem.tintColor = colorThemeComponent.cityDetails.iconColors.wind
    ...
    private lazy var pressureItemView: WeatherQualityItemView = {
        let qualityItem = WeatherQualityItemView()
        qualityItem.imageView.image = UIImage(systemName: Dev.SystemImageName.arrowDownLine,
                                              withConfiguration: DesignManager.standartImageConfiguration)?.withRenderingMode(.alwaysTemplate)
        qualityItem.tintColor = colorThemeComponent.cityDetails.iconColors.pressure
    ...
    private lazy var visibilityItemView: WeatherQualityItemView = {
        let qualityItem = WeatherQualityItemView()
        qualityItem.imageView.image = UIImage(systemName: Dev.SystemImageName.eyeFill,
                                              withConfiguration: DesignManager.standartImageConfiguration)?.withRenderingMode(.alwaysTemplate)
        qualityItem.tintColor = colorThemeComponent.cityDetails.iconColors.visibility
